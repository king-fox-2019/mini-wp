<template>
  <div id="list-posts" class="my-2 container" style="width: 70%">
    <h4 h4 class="my-4 mx-1">Feeds</h4>
    <b-list-group>
      <b-list-group-item class="d-flex align-items-center" v-for="article in articles" :key="article._id">
        ...
        <div class="my-0 ml-auto">
          ...
          <b-dropdown>
            ...
            <b-dropdown-item v-if="myArticles.includes(article._id)" @click.prevent="showEditPost(article._id)">Edit</b-dropdown-item>
            <b-dropdown-item v-if="myArticles.includes(article._id)" @click.prevent="deletePost(article._id)">Delete</b-dropdown-item>
          </b-dropdown>
        </div>
      </b-list-group-item>
    </b-list-group>
