<template>
  <g-signin-button
    ...
    @error="onSignInError">
    <button type="button" class="btn btn-gplus" style="background-color: transparent; border: 0px; cursor: pointer"><i class="fab fa-google-plus-g pr-1"></i> Sign in with Google </button>
  </g-signin-button>
</template>
